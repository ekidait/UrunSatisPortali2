    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "CreateDate", "Email", "IsActive", "IsAdmin", "Name", "Password", "Surname", "UserName", "userGuid" },
                values: new object[] { 1, new DateTime(2024, 12, 13, 19, 50, 15, 243, DateTimeKind.Local).AddTicks(1480), "Dilaratqz@gmail.com", true, true, "Dilara", "123456*", "Topuz", "Ekidait", new Guid("737e1972-3bf2-4c15-87b0-7931eaff3753") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 12, 13, 19, 50, 15, 243, DateTimeKind.Local).AddTicks(4910), null, null, true, true, "Kolye", 1, 0 },
                    { 2, new DateTime(2024, 12, 13, 19, 50, 15, 243, DateTimeKind.Local).AddTicks(4916), null, null, true, true, "Bileklik", 2, 0 }
                });
